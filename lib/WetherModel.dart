/// coord : {"lon":72.8311,"lat":21.1702}
/// weather : [{"id":802,"main":"Clouds","description":"scattered clouds","icon":"03d"}]
/// base : "stations"
/// main : {"temp":303.09,"feels_like":310.09,"temp_min":303.09,"temp_max":303.09,"pressure":1008,"humidity":79}
/// visibility : 6000
/// wind : {"speed":4.12,"deg":210}
/// clouds : {"all":35}
/// dt : 1666093604
/// sys : {"type":1,"id":9071,"country":"IN","sunrise":1666055101,"sunset":1666096947}
/// timezone : 19800
/// id : 1255364
/// name : "Surat"
/// cod : 200
...
class WetherModel {
  ...
  WetherModel.fromJson(dynamic json) {
  ...
  String? _name;
  num? _cod;
WetherModel copyWith({  Coord? coord,
  List<Weather>? weather,
  String? base,
  Main? main,
  num? visibility,
  ...
  String? name,
  num? cod,
}) => WetherModel(  coord: coord ?? _coord,
